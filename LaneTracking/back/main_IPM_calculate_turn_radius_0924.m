...
load data/0924_R/R_data.mat;
% 相机时间
% raw_data_camera_log = importdata('data/0924_R/0921_VN300-camera_152040.ini')';
% raw_data_camera_log = importdata('data/0924_R/0921_VN300-camera_152546.ini')';
% raw_data_camera_log = importdata('data/0924_R/0921_VN300-camera_153047.ini')';
% raw_data_camera_log = importdata('data/0924_R/0921_VN300-camera_153548.ini')';
% raw_data_camera_log = importdata('data/0924_R/0921_VN300-camera_154049.ini')';
% raw_data_camera_log = importdata('data/0924_R/0921_VN300-camera_154550.ini')';
% raw_data_camera_log = importdata('data/0924_R/0921_VN300-camera_155051.ini')';
% raw_data_camera_log = importdata('data/0924_R/0921_VN300-camera_155552.ini')';
% raw_data_camera_log = importdata('data/0924_R/0921_VN300-camera_160053.ini')';
% raw_data_camera_log = importdata('data/0924_R/0921_VN300-camera_160554.ini')';
% raw_data_camera_log = importdata('data/0924_R/0921_VN300-camera_161055.ini')';
% raw_data_camera_log = importdata('data/0924_R/0921_VN300-camera_161556.ini')';
raw_data_camera_log = importdata('data/0924_R/0921_VN300-camera_162057.ini')';

% 写入txt
if SAVE_R
    fp = fopen('F:\Develop\ADAS\Code\matlab\LaneTracking\data\0924_R\car_move_radius_frame_162057.ini', 'wt');
end  
...
if SHOW_IPM
    %% 图片 IPM      
        % 读取图片数据
        str_data = sprintf('data/0924_R/rec_20160924_155552/%08d.jpg',k);
...
%         end
        ...
        %%% 画弯道
%         k_R = k_R - 1
        R_current = R_current_imu_speed; % R_current_VN300; %R_current_steer;
        if R_current ~=0
            j = 0;    
            R_current_abs = abs(R_current);
            x_max_t = min([x_max, R_current_abs]);
